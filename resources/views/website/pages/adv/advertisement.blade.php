...
<td class="v-center">
    ...
    @endif
                                    ...
                                    <td class="v-center">
                                        <a href="{{ route('admin-advertisement.edit', $item->id) }}" class="btn btn-sm btn-success px-4 m-1">Edit</a>
                                        <form action="{{ route('admin-advertisement.destroy', $item->id) }}" method="POST" style="display:inline-block;">
                                            @csrf
                                            @method('DELETE')
