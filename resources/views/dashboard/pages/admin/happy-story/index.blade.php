...
@section('title', 'Dashboard | Add ' . ucfirst('Happy Story'))
...
@section('content')
    ...
    <div class="mb-2 d-flex justify-content-end fw-bold">
        <button id="toggleButton" class="btn btn-sm btn-success px-4 fs-5">Create {{ ucfirst('Happy Story') }}</button>
    </div>
        ...
        <div class="col">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title mb-0">Add {{ ucfirst('Happy Story') }}</h4>
                </div>
                <div class="card-body">
                    <form action="{{ route('admin.happy-story.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="mb-3">
                            <label for="reason" class="form-label">Reason <span class="astrick">*</span></label>
    ...
    <div class="row mt-4">
        <div class="col">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">All {{ ucfirst('Happy Story') }}</h4>
                </div>
                <div class="card-body">
                            ...
                            <tbody>
                                @forelse($items as $item)
                                    <tr>
                                        ...
                                        <td class="v-center">
                                            <a href="{{ route('admin.happy-story.edit', $item->id) }}"
                                                class="btn btn-sm btn-success px-4 m-1">Edit</a>
                                            <form action="{{ route('admin.happy-story.destroy', $item->id) }}"
