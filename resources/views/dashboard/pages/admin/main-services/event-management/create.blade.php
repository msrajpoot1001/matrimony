...
@section('title', 'Dashboard | Add ' . ucfirst('Event Management'))
        ...
        <div class="col">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">All {{ ucfirst('Event Management') }}</h4>
                </div>
                <div class="card-body">
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="banner__inputlist">
                                        <select name="services_offered" class="form-control" required>
                                            <option value="">Select</option>
                                            @foreach (['Marriage', 'Thread Ceremony', 'House Warming', 'Birthday', '100 Days Celebration', 'Shradha', 'Pinda Dana', 'Puja for Harmony', 'Funeral Rituals', 'Other'] as $service)
