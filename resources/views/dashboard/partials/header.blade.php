      ...
      <div class="navbar-header">
          <div class="d-flex">
              ...
              <div class="page-title-box align-self-center d-none d-md-block">
                  <h4 class="page-title mb-0 text-capitalize">Hi, Welcome {{ $company->company_name }}</h4>
              </div>
              <!-- end page title -->
          ...
          <div class="d-flex">
              ...
              <div class="dropdown d-inline-block">
                  <button type="button" class="btn header-item user text-start d-flex align-items-center"
                      ...
                      aria-expanded="false">
                      <h3 style="padding:0px;margin:0px;padding-right: 1rem;">
                          {{ ucfirst($user->userRole->name ?? 'N/A') }}
                      </h3>
                      ...
                      <span
                          class="d-none d-xl-inline-block ms-2 fw-medium font-size-15 text-capitalize">{{ $company->company_name }}</span>
                  </button>
